...
------------ | ------------- | ------------- | -------------
**destination_gaeb_type** | [**DestinationGaebType**](DestinationGaebType.md) | Defaults to GAEB XML V3.2 | 
**target_exchange_phase_transform** | [**DestinationGaebExchangePhase**](DestinationGaebExchangePhase.md) | Defaults to none, meaning no transformation will be done. The phases are: Base &#x3D; 81 CostEstimate &#x3D; 82 OfferRequest &#x3D; 83 Offer &#x3D; 84 SideOffer &#x3D; 85 Grant &#x3D; 86 | 
