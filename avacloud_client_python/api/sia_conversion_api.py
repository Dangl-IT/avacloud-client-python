...
class SiaConversionApi(object):
    ...
    def sia_conversion_convert_to_excel_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['sia_file', 'write_prices', 'write_long_texts', 'conversion_culture', 'include_article_numbers']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def sia_conversion_convert_to_flat_ava(self, **kwargs):  # noqa: E501
        """Converts SIA 451 files to Dangl.AVA projects  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sia_conversion_convert_to_flat_ava(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.sia_conversion_convert_to_flat_ava_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.sia_conversion_convert_to_flat_ava_with_http_info(**kwargs)  # noqa: E501
            return data

    def sia_conversion_convert_to_flat_ava_with_http_info(self, **kwargs):  # noqa: E501
        """Converts SIA 451 files to Dangl.AVA projects  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sia_conversion_convert_to_flat_ava_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sia_conversion_convert_to_flat_ava" % key
                )
            params[key] = val
        del params['kwargs']
