...
class UglConversionApi(object):
    ...
    def ugl_conversion_convert_to_flat_ava(self, **kwargs):  # noqa: E501
        """Converts Ugl files to Dangl.AVA projects  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ugl_conversion_convert_to_flat_ava(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.ugl_conversion_convert_to_flat_ava_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.ugl_conversion_convert_to_flat_ava_with_http_info(**kwargs)  # noqa: E501
            return data

    def ugl_conversion_convert_to_flat_ava_with_http_info(self, **kwargs):  # noqa: E501
        """Converts Ugl files to Dangl.AVA projects  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ugl_conversion_convert_to_flat_ava_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method ugl_conversion_convert_to_flat_ava" % key
                )
            params[key] = val
        del params['kwargs']
