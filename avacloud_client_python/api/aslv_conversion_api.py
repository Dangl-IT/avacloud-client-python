...
class AslvConversionApi(object):
    ...
    def aslv_conversion_convert_to_excel_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['aslv_file', 'write_prices', 'write_long_texts', 'conversion_culture', 'include_article_numbers']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def aslv_conversion_convert_to_flat_ava(self, **kwargs):  # noqa: E501
        """Converts Aslv files to Dangl.AVA projects  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.aslv_conversion_convert_to_flat_ava(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.aslv_conversion_convert_to_flat_ava_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.aslv_conversion_convert_to_flat_ava_with_http_info(**kwargs)  # noqa: E501
            return data

    def aslv_conversion_convert_to_flat_ava_with_http_info(self, **kwargs):  # noqa: E501
        """Converts Aslv files to Dangl.AVA projects  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.aslv_conversion_convert_to_flat_ava_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['aslv_file']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method aslv_conversion_convert_to_flat_ava" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def aslv_conversion_convert_to_gaeb_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['aslv_file', 'destination_gaeb_type', 'target_exchange_phase_transform', 'enforce_strict_offer_phase_long_text_output', 'export_quantity_determination', 'remove_unprintable_characters_from_texts', 'force_include_descriptions', 'treat_null_item_number_schema_as_invalid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
