...
class OenormConversionApi(object):
    ...
    def oenorm_conversion_convert_to_excel_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['oenorm_file', 'write_prices', 'write_long_texts', 'conversion_culture', 'include_article_numbers']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def oenorm_conversion_convert_to_flat_ava(self, **kwargs):  # noqa: E501
        """Converts ÖNorm files to Dangl.AVA projects  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.oenorm_conversion_convert_to_flat_ava(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.oenorm_conversion_convert_to_flat_ava_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.oenorm_conversion_convert_to_flat_ava_with_http_info(**kwargs)  # noqa: E501
            return data

    def oenorm_conversion_convert_to_flat_ava_with_http_info(self, **kwargs):  # noqa: E501
        """Converts ÖNorm files to Dangl.AVA projects  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.oenorm_conversion_convert_to_flat_ava_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['oenorm_file']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method oenorm_conversion_convert_to_flat_ava" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/conversion/oenorm/flat-ava', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
