...
class RebConversionApi(object):
    ...
    def reb_conversion_convert_to_ava(self, **kwargs):  # noqa: E501
        """Converts REB files to Dangl.AVA projects  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reb_conversion_convert_to_ava(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param file reb_file: The input file
        ...
        if kwargs.get('async_req'):
            return self.reb_conversion_convert_to_ava_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.reb_conversion_convert_to_ava_with_http_info(**kwargs)  # noqa: E501
            return data

    def reb_conversion_convert_to_ava_with_http_info(self, **kwargs):  # noqa: E501
        """Converts REB files to Dangl.AVA projects  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reb_conversion_convert_to_ava_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['reb_file', 'remove_plain_text_long_texts', 'remove_html_long_texts']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method reb_conversion_convert_to_ava" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        form_params = []
        local_var_files = {}
        if 'reb_file' in params:
            local_var_files['rebFile'] = params['reb_file']  # noqa: E501
    ...
    def reb_conversion_convert_to_excel(self, **kwargs):  # noqa: E501
        """Converts REB files to Excel  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reb_conversion_convert_to_excel(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.reb_conversion_convert_to_excel_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.reb_conversion_convert_to_excel_with_http_info(**kwargs)  # noqa: E501
            return data

    def reb_conversion_convert_to_excel_with_http_info(self, **kwargs):  # noqa: E501
        """Converts REB files to Excel  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reb_conversion_convert_to_excel_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['reb_file', 'write_prices', 'write_long_texts', 'conversion_culture', 'include_article_numbers']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method reb_conversion_convert_to_excel" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def reb_conversion_convert_to_flat_ava(self, **kwargs):  # noqa: E501
        """Converts REB files to Dangl.AVA projects  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reb_conversion_convert_to_flat_ava(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.reb_conversion_convert_to_flat_ava_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.reb_conversion_convert_to_flat_ava_with_http_info(**kwargs)  # noqa: E501
            return data

    def reb_conversion_convert_to_flat_ava_with_http_info(self, **kwargs):  # noqa: E501
        """Converts REB files to Dangl.AVA projects  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reb_conversion_convert_to_flat_ava_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method reb_conversion_convert_to_flat_ava" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def reb_conversion_convert_to_gaeb(self, **kwargs):  # noqa: E501
        """Converts REB files to GAEB files  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reb_conversion_convert_to_gaeb(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.reb_conversion_convert_to_gaeb_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.reb_conversion_convert_to_gaeb_with_http_info(**kwargs)  # noqa: E501
            return data

    def reb_conversion_convert_to_gaeb_with_http_info(self, **kwargs):  # noqa: E501
        """Converts REB files to GAEB files  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reb_conversion_convert_to_gaeb_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['reb_file', 'destination_gaeb_type', 'target_exchange_phase_transform', 'enforce_strict_offer_phase_long_text_output', 'export_quantity_determination', 'remove_unprintable_characters_from_texts', 'force_include_descriptions', 'treat_null_item_number_schema_as_invalid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method reb_conversion_convert_to_gaeb" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def reb_conversion_convert_to_oenorm(self, **kwargs):  # noqa: E501
        """Converts REB files to Oenorm  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reb_conversion_convert_to_oenorm(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.reb_conversion_convert_to_oenorm_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.reb_conversion_convert_to_oenorm_with_http_info(**kwargs)  # noqa: E501
            return data

    def reb_conversion_convert_to_oenorm_with_http_info(self, **kwargs):  # noqa: E501
        """Converts REB files to Oenorm  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reb_conversion_convert_to_oenorm_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['reb_file', 'destination_oenorm_type', 'try_repair_project_structure', 'skip_try_enforce_schema_compliant_xml_output', 'remove_unprintable_characters_from_texts']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method reb_conversion_convert_to_oenorm" % key
                )
            params[key] = val
        del params['kwargs']
