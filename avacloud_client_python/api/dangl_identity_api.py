...
class DanglIdentityApi(object):
    ...
    def dangl_identity_get_user_info(self, **kwargs):  # noqa: E501
        """dangl_identity_get_user_info  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dangl_identity_get_user_info(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.dangl_identity_get_user_info_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.dangl_identity_get_user_info_with_http_info(**kwargs)  # noqa: E501
            return data

    def dangl_identity_get_user_info_with_http_info(self, **kwargs):  # noqa: E501
        """dangl_identity_get_user_info  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dangl_identity_get_user_info_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method dangl_identity_get_user_info" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='UserInfoGet',  # noqa: E501
