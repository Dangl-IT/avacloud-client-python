...
class ExcelConversionApi(object):
    ...
    def excel_conversion_convert_to_ava(self, **kwargs):  # noqa: E501
        """Converts Excel files to Dangl.AVA projects.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.excel_conversion_convert_to_ava(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param file excel_file: The input file
        :param bool read_new_elements: Defaults to false
        :param bool rebuild_item_number_schema: When importing new elements from Excel, sometimes the ItemNumberSchema in the file is not in compliance with the GAEB requirements. Enabling this option tries to repair the ItemNumberSchema. Defaults to false.
        ...
        if kwargs.get('async_req'):
            return self.excel_conversion_convert_to_ava_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.excel_conversion_convert_to_ava_with_http_info(**kwargs)  # noqa: E501
            return data

    def excel_conversion_convert_to_ava_with_http_info(self, **kwargs):  # noqa: E501
        """Converts Excel files to Dangl.AVA projects.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.excel_conversion_convert_to_ava_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['excel_file', 'read_new_elements', 'rebuild_item_number_schema', 'remove_plain_text_long_texts', 'remove_html_long_texts']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method excel_conversion_convert_to_ava" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        query_params = []
        if 'read_new_elements' in params:
            query_params.append(('ReadNewElements', params['read_new_elements']))  # noqa: E501
        if 'rebuild_item_number_schema' in params:
            query_params.append(('RebuildItemNumberSchema', params['rebuild_item_number_schema']))  # noqa: E501
        ...
        if 'excel_file' in params:
            local_var_files['excelFile'] = params['excel_file']  # noqa: E501
    ...
    def excel_conversion_convert_to_excel(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.excel_conversion_convert_to_excel(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.excel_conversion_convert_to_excel_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.excel_conversion_convert_to_excel_with_http_info(**kwargs)  # noqa: E501
            return data

    def excel_conversion_convert_to_excel_with_http_info(self, **kwargs):  # noqa: E501
        """Converts Excel files to Excel files. Used, for example, when elements were added in excel to generate or modify a project. The Excel file can then be shared containing the full project with all formattings, formulas and styles applied.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.excel_conversion_convert_to_excel_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['excel_file', 'read_new_elements', 'rebuild_item_number_schema', 'write_prices', 'write_long_texts', 'conversion_culture', 'include_article_numbers']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method excel_conversion_convert_to_excel" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def excel_conversion_convert_to_flat_ava(self, **kwargs):  # noqa: E501
        """Converts Excel files to Dangl.AVA projects.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.excel_conversion_convert_to_flat_ava(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.excel_conversion_convert_to_flat_ava_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.excel_conversion_convert_to_flat_ava_with_http_info(**kwargs)  # noqa: E501
            return data

    def excel_conversion_convert_to_flat_ava_with_http_info(self, **kwargs):  # noqa: E501
        """Converts Excel files to Dangl.AVA projects.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.excel_conversion_convert_to_flat_ava_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['excel_file', 'read_new_elements', 'rebuild_item_number_schema']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method excel_conversion_convert_to_flat_ava" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/conversion/excel/flat-ava', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def excel_conversion_convert_to_gaeb(self, **kwargs):  # noqa: E501
        """Converts Excel files to GAEB files.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.excel_conversion_convert_to_gaeb(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.excel_conversion_convert_to_gaeb_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.excel_conversion_convert_to_gaeb_with_http_info(**kwargs)  # noqa: E501
            return data

    def excel_conversion_convert_to_gaeb_with_http_info(self, **kwargs):  # noqa: E501
        """Converts Excel files to GAEB files.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.excel_conversion_convert_to_gaeb_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method excel_conversion_convert_to_gaeb" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def excel_conversion_convert_to_oenorm(self, **kwargs):  # noqa: E501
        """Converts Excel files to Oenorm files.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.excel_conversion_convert_to_oenorm(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.excel_conversion_convert_to_oenorm_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.excel_conversion_convert_to_oenorm_with_http_info(**kwargs)  # noqa: E501
            return data

    def excel_conversion_convert_to_oenorm_with_http_info(self, **kwargs):  # noqa: E501
        """Converts Excel files to Oenorm files.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.excel_conversion_convert_to_oenorm_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['excel_file', 'read_new_elements', 'rebuild_item_number_schema', 'destination_oenorm_type', 'try_repair_project_structure', 'skip_try_enforce_schema_compliant_xml_output', 'remove_unprintable_characters_from_texts']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method excel_conversion_convert_to_oenorm" % key
                )
            params[key] = val
        del params['kwargs']
