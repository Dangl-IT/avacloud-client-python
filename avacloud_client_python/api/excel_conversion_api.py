...
class ExcelConversionApi(object):
    ...
    def excel_conversion_convert_to_excel_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['excel_file', 'read_new_elements', 'rebuild_item_number_schema', 'write_prices', 'write_long_texts', 'conversion_culture']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def excel_conversion_convert_to_gaeb_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['excel_file', 'read_new_elements', 'rebuild_item_number_schema', 'destination_gaeb_type', 'target_exchange_phase_transform', 'enforce_strict_offer_phase_long_text_output', 'export_quantity_determination', 'remove_unprintable_characters_from_texts', 'force_include_descriptions']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
