...
class NoteTextDto(object):
    ...
    def __init__(self, is_opening_text=None, is_closing_text=None, short_text=None, addition_type=None, long_text=None, html_long_text=None, identifier=None, standardized_description=None, element_type=None, description_id=None, oenorm_note_text_properties=None, _configuration=None):  # noqa: E501
