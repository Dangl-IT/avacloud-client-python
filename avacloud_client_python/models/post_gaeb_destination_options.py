...
class PostGaebDestinationOptions(object):
    ...
    def __init__(self, destination_gaeb_type=None, target_exchange_phase_transform=None, enforce_strict_offer_phase_long_text_output=None, export_quantity_determination=None, remove_unprintable_characters_from_texts=None, force_include_descriptions=None, _configuration=None):  # noqa: E501
    ...
    def remove_unprintable_characters_from_texts(self):
        ...
        If this is enabled, unprintable characters are removed from text elements. Otherwise, the conversion might fail in case some text content contains characters that are not allowed in XML output formats.  # noqa: E501
