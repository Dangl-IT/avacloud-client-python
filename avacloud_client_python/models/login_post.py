...
class LoginPost(object):
    ...
    def __init__(self, identifier=None, password=None, stay_signed_in=None, _configuration=None):  # noqa: E501
    ...
    def stay_signed_in(self, stay_signed_in):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and stay_signed_in is None:
