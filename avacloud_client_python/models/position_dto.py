...
class PositionDto(IElementDto):
    ...
    swagger_types = {
        ...
        'long_text': 'str',
        'html_long_text': 'str',
        'addition_type': 'object',
        'element_type': 'str',
        'quantity_assignments': 'list[QuantityAssignmentDto]',
        'commerce_properties': 'object',
        'alternative_to': 'str',
        'is_lump_sum': 'bool',
        'repetition_to': 'str',
        'type': 'str',
        'standardized_description': 'object'
    }
    ...
    def complemented_by(self):
        ...
        A list of positions that complement this Position. The positions are referenced by their GUIDs.               # noqa: E501
    ...
    def complemented(self):
        ...
        Will indicate if this Position is complemented in this ServiceSpecification by other Positions.               # noqa: E501
