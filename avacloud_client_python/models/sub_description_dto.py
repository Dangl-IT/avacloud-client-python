...
class SubDescriptionDto(object):
    ...
    def __init__(self, id=None, quantity=None, quantity_components=None, amount_to_be_entered_by_bidder=None, identifier=None, short_text=None, long_text=None, html_long_text=None, addition_type=None, standardized_description=None):  # noqa: E501
