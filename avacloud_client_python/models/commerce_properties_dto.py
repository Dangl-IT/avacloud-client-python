...
class CommercePropertiesDto(object):
    ...
    def __init__(self, article_number=None, ean_gtin_article_number=None, iln_article_number=None, catalogue_number=None, catalogue_article_number=None, _configuration=None):  # noqa: E501
