...
class ServiceSpecificationGroupDto(object):
    ...
    def __init__(self, project_hourly_wage=None, project_tax_rate=None, project_price_components=None, project_item_number_schema=None, elements=None, project_labour_time_label=None, contains_duplicate_item_numbers=None, contains_duplicate_element_ids=None, ignore_duplicate_item_numbers=None, ignore_duplicate_element_ids=None, total_price_gross_by_tax_rate=None, ignore_child_price_updates=None, deducted_price=None, deduction_factor=None, total_price=None, total_price_gross=None, total_price_gross_deducted=None, price_type=None, short_text=None, comission_status=None, item_number=None, element_type=None, is_lot=None, alternative_to=None, type=None, project_catalogues=None, catalogue_references=None, oenorm_properties=None, hierarchy_level=None, addendum_status=None, _configuration=None):  # noqa: E501
