...
class ArticleDataDto(object):
    ...
    def __init__(self, id=None, name=None, article_number=None, quantity=None, unit_tag=None, description=None, short_text=None, long_text=None, html_long_text=None):  # noqa: E501
