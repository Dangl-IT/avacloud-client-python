...
class ProjectDto(object):
    ...
    def __init__(self, id=None, price_accuracy=None, unit_price_accuracy=None, force_strict_totals=None, price_rounding_mode=None, project_information=None, service_specifications=None, gaeb_xml_id=None, _configuration=None):  # noqa: E501
        ...
        self._unit_price_accuracy = None
        ...
        if unit_price_accuracy is not None:
            self.unit_price_accuracy = unit_price_accuracy
    ...
    @property
    def unit_price_accuracy(self):
        """Gets the unit_price_accuracy of this ProjectDto.  # noqa: E501

        This property controls the accuracy of position unit price properties, meaning how many decimal places are preserved in calculations. Please see the Dangl.AVA documentation for further information about decimal precision. This can be separately set from PriceAccuracy, and it only controls the accuracy of the unit price of positions, not the total price. It defaults to null, which means the standard PriceAccuracy is used for unit prices.  # noqa: E501

        :return: The unit_price_accuracy of this ProjectDto.  # noqa: E501
        :rtype: int
        """
        return self._unit_price_accuracy

    @unit_price_accuracy.setter
    def unit_price_accuracy(self, unit_price_accuracy):
        """Sets the unit_price_accuracy of this ProjectDto.

        This property controls the accuracy of position unit price properties, meaning how many decimal places are preserved in calculations. Please see the Dangl.AVA documentation for further information about decimal precision. This can be separately set from PriceAccuracy, and it only controls the accuracy of the unit price of positions, not the total price. It defaults to null, which means the standard PriceAccuracy is used for unit prices.  # noqa: E501

        :param unit_price_accuracy: The unit_price_accuracy of this ProjectDto.  # noqa: E501
        :type: int
        """

        self._unit_price_accuracy = unit_price_accuracy
