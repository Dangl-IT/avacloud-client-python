...
class CatalogueDto(object):
    ...
    def __init__(self, id=None, gaeb_xml_id=None, name=None, description=None, catalogue_type=None, catalogue_type_detail=None, _configuration=None):  # noqa: E501
        ...
        self._catalogue_type_detail = None
        ...
        if catalogue_type_detail is not None:
            self.catalogue_type_detail = catalogue_type_detail
    ...
    @property
    def catalogue_type_detail(self):
        """Gets the catalogue_type_detail of this CatalogueDto.  # noqa: E501

        This property may hold additional information about the catalogue type. It is currently only used in GAEB XML exchange to carry detailed information about a catalogue type, but it's otherwise just a free text field.  # noqa: E501

        :return: The catalogue_type_detail of this CatalogueDto.  # noqa: E501
        :rtype: str
        """
        return self._catalogue_type_detail

    @catalogue_type_detail.setter
    def catalogue_type_detail(self, catalogue_type_detail):
        """Sets the catalogue_type_detail of this CatalogueDto.

        This property may hold additional information about the catalogue type. It is currently only used in GAEB XML exchange to carry detailed information about a catalogue type, but it's otherwise just a free text field.  # noqa: E501

        :param catalogue_type_detail: The catalogue_type_detail of this CatalogueDto.  # noqa: E501
        :type: str
        """

        self._catalogue_type_detail = catalogue_type_detail
