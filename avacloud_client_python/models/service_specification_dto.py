...
class ServiceSpecificationDto(object):
    ...
    swagger_types = {
        ...
        'commerce_properties': 'ServiceSpecificationCommercePropertiesDto'
    }
    ...
    def __init__(self, id=None, project_hourly_wage=None, project_tax_rate=None, project_price_components=None, project_item_number_schema=None, elements=None, project_labour_time_label=None, contains_duplicate_item_numbers=None, contains_duplicate_element_ids=None, ignore_duplicate_item_numbers=None, ignore_project_catalogue_propagation=None, ignore_duplicate_element_ids=None, total_price_gross_by_tax_rate=None, ignore_child_price_updates=None, deducted_price=None, deduction_factor=None, absolute_deduction=None, total_price=None, total_price_gross=None, total_price_gross_deducted=None, price_type=None, bidder=None, bidder_discriminator=None, gaeb_xml_id=None, project_information=None, exchange_phase=None, origin=None, origin_detail=None, creation_date=None, offer_by_date=None, decision_date=None, bid_date=None, warranty_bond_percentage=None, execution_guarantee_percentage=None, submission_location=None, description=None, name=None, price_information=None, project_catalogues=None, catalogue_references=None, planned_execution_start=None, planned_execution_end=None, contract_date=None, contract_identifier=None, warranty_duration=None, warranty_end=None, approval_date=None, type_of_approval=None, addendum_number=None, addendum_status=None, commerce_properties=None, _configuration=None):  # noqa: E501
        ...
        self._bid_date = None
        self._warranty_bond_percentage = None
        self._execution_guarantee_percentage = None
        ...
        self.warranty_bond_percentage = warranty_bond_percentage
        self.execution_guarantee_percentage = execution_guarantee_percentage
    ...
    def ignore_project_catalogue_propagation(self):
        """Gets the ignore_project_catalogue_propagation of this ServiceSpecificationDto.  # noqa: E501
        ...
        :return: The ignore_project_catalogue_propagation of this ServiceSpecificationDto.  # noqa: E501
        :rtype: bool
        """
    ...
    def ignore_project_catalogue_propagation(self, ignore_project_catalogue_propagation):
        """Sets the ignore_project_catalogue_propagation of this ServiceSpecificationDto.

        If this is set to true, the ProjectCatalogues property will not be propagated to child elements. This is useful in mapping scenarios, where you want to disable propagation for multiple changes, and only enable it once you have mapped all properties  # noqa: E501

        :param ignore_project_catalogue_propagation: The ignore_project_catalogue_propagation of this ServiceSpecificationDto.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def bid_date(self):
        """Gets the bid_date of this ServiceSpecificationDto.  # noqa: E501

        Date of when the offer / bid was created  # noqa: E501

        :return: The bid_date of this ServiceSpecificationDto.  # noqa: E501
        :rtype: datetime
        """
    ...
    def bid_date(self, bid_date):
        """Sets the bid_date of this ServiceSpecificationDto.

        Date of when the offer / bid was created  # noqa: E501

        :param bid_date: The bid_date of this ServiceSpecificationDto.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def warranty_bond_percentage(self):
        """Gets the warranty_bond_percentage of this ServiceSpecificationDto.  # noqa: E501

        If a construction project requires a warranty bond, this property indicates the amount as a percentage, e.g. '0.15m' means 15% of the construction total amount as a warranty bond.  # noqa: E501

        :return: The warranty_bond_percentage of this ServiceSpecificationDto.  # noqa: E501
        :rtype: float
        """
        return self._warranty_bond_percentage

    @warranty_bond_percentage.setter
    def warranty_bond_percentage(self, warranty_bond_percentage):
        """Sets the warranty_bond_percentage of this ServiceSpecificationDto.

        If a construction project requires a warranty bond, this property indicates the amount as a percentage, e.g. '0.15m' means 15% of the construction total amount as a warranty bond.  # noqa: E501

        :param warranty_bond_percentage: The warranty_bond_percentage of this ServiceSpecificationDto.  # noqa: E501
        :type: float
        """
        if self._configuration.client_side_validation and warranty_bond_percentage is None:
            raise ValueError("Invalid value for `warranty_bond_percentage`, must not be `None`")  # noqa: E501

        self._warranty_bond_percentage = warranty_bond_percentage

    @property
    def execution_guarantee_percentage(self):
        """Gets the execution_guarantee_percentage of this ServiceSpecificationDto.  # noqa: E501

        If a construction project requires an execution guarantty, this property indicates the amount as a percentage, e.g. '0.15m' means 15% of the construction total amount as an execution guarantee. In practice, this percentage is usually deducted from intermediate invoices and only billed in the final invoice.  # noqa: E501

        :return: The execution_guarantee_percentage of this ServiceSpecificationDto.  # noqa: E501
        :rtype: float
        """
        return self._execution_guarantee_percentage

    @execution_guarantee_percentage.setter
    def execution_guarantee_percentage(self, execution_guarantee_percentage):
        """Sets the execution_guarantee_percentage of this ServiceSpecificationDto.

        If a construction project requires an execution guarantty, this property indicates the amount as a percentage, e.g. '0.15m' means 15% of the construction total amount as an execution guarantee. In practice, this percentage is usually deducted from intermediate invoices and only billed in the final invoice.  # noqa: E501

        :param execution_guarantee_percentage: The execution_guarantee_percentage of this ServiceSpecificationDto.  # noqa: E501
        :type: float
        """
        if self._configuration.client_side_validation and execution_guarantee_percentage is None:
            raise ValueError("Invalid value for `execution_guarantee_percentage`, must not be `None`")  # noqa: E501

        self._execution_guarantee_percentage = execution_guarantee_percentage
    ...
    def commerce_properties(self):
        """Gets the commerce_properties of this ServiceSpecificationDto.  # noqa: E501

        This property holds additional information that's only valid in commerce exchange phases.  # noqa: E501

        :return: The commerce_properties of this ServiceSpecificationDto.  # noqa: E501
        :rtype: ServiceSpecificationCommercePropertiesDto
        """
        return self._commerce_properties

    @commerce_properties.setter
    def commerce_properties(self, commerce_properties):
        """Sets the commerce_properties of this ServiceSpecificationDto.

        This property holds additional information that's only valid in commerce exchange phases.  # noqa: E501

        :param commerce_properties: The commerce_properties of this ServiceSpecificationDto.  # noqa: E501
