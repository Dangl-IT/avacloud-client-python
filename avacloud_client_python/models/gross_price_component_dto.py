...
class GrossPriceComponentDto(object):
    ...
    def __init__(self, tax_rate=None, deduction_factor=None, total_net=None, total_deducted=None, total_tax=None, total_gross=None, total_gross_deducted=None, total_tax_deducted=None):  # noqa: E501
    ...
    def total_gross_deducted(self, total_gross_deducted):
        ...
        :type: float
        """
        if total_gross_deducted is None:
